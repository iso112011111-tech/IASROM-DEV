...
- เครื่องมือในไลน์ที่แนะนำลูกค้าได้ (บอกให้พิมพ์คำนี้ในแชต): "จองคิว" = นัดปรึกษา/ส่งซ่อม/นัดสำรวจ CCTV เลือกวันเวลาเอง ·
  "ออกแบบเว็บ" = ให้ AI ออกแบบหน้าเว็บตัวอย่างของร้านลูกค้าให้ดูฟรีใน ~15 วินาที · "ติดตามงาน" = ดูสถานะงาน/งานซ่อมที่ส่งไว้
